...
import { Heart, MessageCircle, Share2, Podcast, Network, Search, Wand2 } from 'lucide-react';
  ...
  <div className="bg-black/40 backdrop-blur-xl rounded-lg overflow-hidden mb-8 border border-white/5 shadow-[0_8px_32px_rgba(0,0,0,0.37)]">
    ...
    <div className="p-4 bg-black/20 backdrop-blur-sm">
      ...
      <div className="flex flex-wrap gap-2 mt-4 pt-4 border-t border-white/10">
        <button className="flex items-center space-x-2 px-3 py-1.5 bg-white/5 hover:bg-white/10 rounded-lg transition-colors text-sm text-white/70 hover:text-white">
